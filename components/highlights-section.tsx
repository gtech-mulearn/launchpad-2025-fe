import { Target, MapPin, Users, NotepadText } from "lucide-react";
        ...
        <div className="flex flex-col items-center justify-center space-y-12 text-center">
          <div className="space-y-6 max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white uppercase tracking-tighter leading-tight">
              Launchpad Kerala{" "}
              <span className="text-primary-500">Highlights</span>
            </h2>
            <p className="text-gray-400 text-lg ">
              What makes Launchpad Kerala 2025 stand out from other job fairs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 w-full">
            <div className="bg-secondary-800 border border-primary-500/20 p-8 hover:border-primary-500 transition-all duration-300 animate-slide-in-left">
              <div className="flex flex-col items-start text-left space-y-4">
                ...
                <p className="text-gray-400 text-justify">
                  Launchpad Kerala 2025’s assessment approach is skills-first —
                  candidates showcase their abilities through completed tasks,
                  earned karma points and real project proofs. Whether through
                  μLearn challenges or external portfolios, only proven,
                  job-ready talent moves forward to interviews.
                </p>
              </div>
            </div>
            ...
            <div className="bg-secondary-800 border border-primary-500/20 p-8 hover:border-primary-500 transition-all duration-300 animate-slide-in-left delay-200">
              <div className="flex flex-col items-start text-left space-y-4">
                ...
                <div className="w-12 h-0.5 bg-primary-500 "></div>
                <p className="text-gray-400 text-justify">
                  Shortlisted candidates for Launchpad Kerala 2025 can opt for
                  interviews in Trivandrum, Kochi, or Kozhikode, streamlining
                  the hiring process for companies and maximizing participation
                  from top talent.
                </p>
              </div>
            </div>
            ...
            <div className="bg-secondary-800 border border-primary-500/20 p-8 hover:border-primary-500 transition-all duration-300 animate-slide-in-left delay-400">
              <div className="flex flex-col items-start text-left space-y-4">
                ...
                <div className="w-12 h-0.5 bg-primary-500"></div>
                <p className="text-gray-400 text-justify">
                  Launchpad Kerala 2025 boasts a diverse talent pool sourced
                  from across Kerala, catering to various skill sets and
                  experience levels, providing companies with access to top-tier
                  candidates for a multitude of roles.
                </p>
              </div>
            </div>
          </div>
