                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {candidate.interest_groups.map((ig, index) => (
                      <Badge
                        key={index}
                        variant="outline"
                        className="text-xs sm:text-sm border-primary-500/30 text-primary-400"
                      >
                        {ig.name}
                      </Badge>
                    ))}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                      {candidate.application_details.resume_link && (
                        <Button
                          size="sm"
                          variant="outline"
                          className="bg-button-secondary-500/30 border-primary-500/30 text-white text-xs sm:text-sm"
                          asChild
                        >
                          <a
